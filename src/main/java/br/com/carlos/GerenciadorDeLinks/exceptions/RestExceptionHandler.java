...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    private ResponseEntity<RestErrorMessage> userNotFoundHandler(UserAlreadyExists exception) {
    ...
    private ResponseEntity<RestErrorMessage> linkNotFoundHandler(UserAlreadyExists exception) {
        RestErrorMessage response = new RestErrorMessage(HttpStatus.NOT_FOUND, exception.getMessage());
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(response);
    }
}
